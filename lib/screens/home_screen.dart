            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text("Hi, Fade!", style: TextStyle(color: Colors.white, fontSize: 30),
                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(right: 2,top: 2, child: Container(decoration: const BoxDecoration(shape: BoxShape.circle, color: kButtonColor,),
                        height: 10, width: 10,
                        ))
                      ],
                    )
